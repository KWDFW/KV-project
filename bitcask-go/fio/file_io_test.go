...
// TestNewFileIOManger tests creating a new FileIOManger instance.
// It verifies that the returned manager is not nil and error is nil.
func TestNewFileIOManger(t *testing.T) {
	path := filepath.Join("/tmp", "a.data")
	fio, err := NewFileIOManger(filepath.Join(path))
